...
const CourseEdit = () => {
  ...
  const {
    ...
    control,
    name: "courseİnformationRequests",
  });
  ...
  useEffect(() => {
    const fetchCourseData = async () => {
      try {
        ...
        const data = response.data;
        console.log(data);
        setValue("coursuCreator", data.coursuCreator);
        setValue("courceName", data.courceName);
        setValue("credit", data.credit);
        setValue("courseContentRequests", data.courseContents || []);
        setValue("courseCriteriaRequests", data.courseCriterias || []);
        // Ensure that the courseInformations is an array and set it
        setValue("courseİnformationRequests", data.courseİnformations || []);
      } catch (error) {
        console.error("Error fetching course data:", error);
      }
    };
